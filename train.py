...
def build_parser():
    ...
    parser.add_argument("--object_heatmap_weight", type=float, default=50.0)
    parser.add_argument("--object_interaction_loss_weight", type=float, default=0.10)
    parser.add_argument("--object_warmup_freeze_actor_path", type=int, default=0)
    parser.add_argument("--object_counterfactual_margin_weight", type=float, default=0.10)
    ...
    parser.add_argument("--object_action_sensitivity_weight", type=float, default=0.0)
    parser.add_argument("--object_action_sensitivity_margin", type=float, default=0.05)
    parser.add_argument("--object_action_group_sensitivity_weight", type=float, default=0.0)
    parser.add_argument("--object_action_group_sensitivity_margin", type=float, default=0.05)
    parser.add_argument("--object_sufficiency_weight", type=float, default=0.0)
    parser.add_argument("--object_class_swap_weight", type=float, default=0.0)
    parser.add_argument("--object_class_swap_margin", type=float, default=0.05)
    parser.add_argument("--object_group_ce_weight", type=float, default=0.0)
    parser.add_argument("--object_objectless_consistency_weight", type=float, default=0.02)
