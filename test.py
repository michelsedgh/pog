...
if __name__ == "__main__":
    ...
    parser.add_argument("--actor_prompt", type=int, default=None)
    ...
    parser.add_argument("--actor_interaction_heatmaps", type=int, default=None)
    ...
    parser.add_argument("--object_track_iou_threshold", type=float, default=None)
