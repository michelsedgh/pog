...
cmd = [
    ...
    "--actor_object_slot_prior_incompatible", "-1.50",
    "--actor_object_slot_unknown_init_bias", "-0.75",
    "--actor_object_slot_unknown_mismatch_penalty", "2.0",
    ...
    "--object_slot_unknown_exact_loss_weight", "0.5",
