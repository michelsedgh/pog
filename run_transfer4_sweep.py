...
TRANSFER4_SWEEP = [
    ...
    (
        ...
        "Range test: if paused laptop is a state-supervision problem, this should raise laptop engagement and live transfer.",
        {
            ...
            "--actor_object_binding_state_loss_weight": "1.25",
            "--actor_object_binding_margin": "0.50",
    ...
    (
        ...
        "Destructive proof: if this wins validation but fails live, object pressure is overriding visual/actor semantics.",
        {
            ...
            "--actor_object_engagement_loss_weight": "1.20",
            "--actor_object_binding_state_loss_weight": "1.50",
            "--actor_object_binding_margin": "0.50",
...
def build_working_cell_base_cmd(env: dict[str, str], run_name: str, epoch_dir: Path) -> list[str]:
    ...
    return [
        ...
        "--toyota_actor_box_jitter_prob",
        "0.8",
        "--toyota_actor_box_center_jitter",
        "0.08",
        "--toyota_actor_box_scale_min",
        "0.9",
        "--toyota_actor_box_scale_max",
        "1.3",
        "--toyota_split_source",
        "auto",
        "--toyota_val_fraction",
